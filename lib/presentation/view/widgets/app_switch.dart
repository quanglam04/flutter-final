...
const double _kTrackHeight = 16;
const double _kTrackWidth = 32;
const Size _kSwitchSize = Size(10.0, 20.0);
...
///
/// {@tool dartpad}
/// This example shows a toggleable [AppCupertinoSwitch]. When the thumb slides to
...
/// {@tool snippet}
///
/// This sample shows how to use a [AppCupertinoSwitch] in a [CupertinoListTile]. The
...
class AppCupertinoSwitch extends StatefulWidget {
  ...
  /// The outline color of this [AppCupertinoSwitch]'s track.
  ///
  ...
  /// [WidgetState] of the [AppCupertinoSwitch], providing a different [Color] when it is
  /// [WidgetState.disabled].
  ///
  /// ```dart
  /// AppCupertinoSwitch(
  ...
  /// {@end-tool}
  ///
  /// The [AppCupertinoSwitch] track has no outline by default.
  final WidgetStateProperty<Color?>? trackOutlineColor;

  /// The outline width of this [AppCupertinoSwitch]'s track.
  ///
  /// Resolved in the following states:
  ///  * [WidgetState.selected].
  ///  * [WidgetState.hovered].
  ...
  /// [WidgetState] of the [AppCupertinoSwitch], providing a different outline width when it is
  /// [WidgetState.disabled].
  ///
  /// ```dart
  /// AppCupertinoSwitch(
  ...
  /// {@end-tool}
  ///
  /// Since a [AppCupertinoSwitch] has no track outline by default, this parameter
  ...
  /// [WidgetState] of the [AppCupertinoSwitch], providing a different [Icon] when it is
  /// [WidgetState.disabled].
  ///
  /// ```dart
  /// AppCupertinoSwitch(
  ...
  /// {@end-tool}
  ///
  /// If null, then the [AppCupertinoSwitch] does not have any icons on the thumb.
  ...
  /// [WidgetState] of the [AppCupertinoSwitch], providing a different [mouseCursor] when it is
  /// [WidgetState.disabled].
  ///
  /// ```dart
  /// AppCupertinoSwitch(
  ...
  /// {@template flutter.cupertino.AppCupertinoSwitch.applyTheme}
  ...
  /// {@template flutter.cupertino.AppCupertinoSwitch.dragStartBehavior}
...
class _AppCupertinoSwitchState extends State<AppCupertinoSwitch>
  ...
  @override
  void didUpdateWidget(AppCupertinoSwitch oldWidget) {
